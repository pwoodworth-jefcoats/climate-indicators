...
pal <- c(oceans[3], oceans[1], seasonadj, coral[3])

# Plot
pdf(paste(Dir, '/AtmosphericCO2_ts_', RptYr, '.pdf', sep = ""), width = 7, height = 4.5)
plot(atm_co2$`decimal date`[all_yrs], atm_co2$deseasonalized[all_yrs], type = "l", lwd = 2, col = seasonadj, 
...
write_csv(CO2_dashboard, file = here("Indicator_Dashboard", "Data", paste('CO2_Dashboard_Data_', RptYr, '.csv', sep = "")))
```
