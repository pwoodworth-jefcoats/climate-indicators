...
plot(dmy_hm(indicator_data$Date_Time), indicator_data$Value, type = "l", lwd = 2, 
     xlim = c(min(dmy_hm(indicator_data$Date_Time)), max(dmy_hm(indicator_data$Date_Time))), ylim = c(300, 430), 
     ...
     panel.first = c(abline(v = x_grid, col = "#F1F3F3"),
                     abline(h = c(seq(300, 420, 20), 430), col = "#F1F3F3")),
     font.lab = 2)
par(new = TRUE)
...
plot(dmy_hm(given_yr_ann$Date_Time), given_yr_ann$Value, type = "l", lwd = 2,
     ...
     col = pal[2],
     xlab = " ", ylab = " ")
axis(1, at = x_grid, label = c(" ", seq(1960, 2020, 10), " "), col = "transparent", col.ticks = "transparent") 
axis(2, at = c(seq(300, 420, 20), 430), las = 1, col = "transparent", col.ticks = "transparent")
dev.off()
