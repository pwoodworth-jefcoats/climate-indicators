...
plot(c(min(dmy_hm(indicator_data$Date_Time)), max(dmy_hm(indicator_data$Date_Time))), c(0, 0), col = "black", 
     type = "l", lwd = 1,
     xlim = c(min(dmy_hm(indicator_data$Date_Time)), max(dmy_hm(indicator_data$Date_Time))), ylim = c(-3, 3),
     ...
     font.lab = 2)
par(new = TRUE)
stem(dmy_hm(indicator_data$Date_Time[ElNino_idx]), indicator_data$Value[ElNino_idx], pal[2])
stem(dmy_hm(indicator_data$Date_Time[LaNina_idx]), indicator_data$Value[LaNina_idx], oceans[2])
stem(dmy_hm(indicator_data$Date_Time[Neutral_idx]), indicator_data$Value[Neutral_idx], ann_grey)
