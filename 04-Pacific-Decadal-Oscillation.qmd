...
```{r}
# Direct CSV URL
csv_url <- "https://psl.noaa.gov/pdo/data/pdo.timeseries.ersstv5.csv"
#Read the CSV file directly into R
PDO_full <- read.csv(csv_url, stringsAsFactors = FALSE)
### Rename the PDO column to something reasonable
names(pdo_raw)[2] <- 'PDO'

# Optional save
#write.csv(PDO_full, file = paste(Dir, '/PDO_', RptYr, '.csv', sep = ""), quote = F, row.names = F)
```
...
#| include: false
# ### Load data
# # Comment this out if you are running above code to download the data
