...
plot(c(min(dmy_hm(indicator_data$Date_Time)), max(dmy_hm(indicator_data$Date_Time))), c(0, 0), col = "black", 
     type = "l", lwd = 1,
     xlim = c(min(dmy_hm(indicator_data$Date_Time)), max(dmy_hm(indicator_data$Date_Time))), ylim = c(-5, 5),
     ...
     font.lab = 2)
par(new = TRUE)
stem(dmy_hm(indicator_data$Date_Time[Pos_idx]), indicator_data$Value[Pos_idx], pal[2])
stem(dmy_hm(indicator_data$Date_Time[Neg_idx]), indicator_data$Value[Neg_idx], oceans[2])
