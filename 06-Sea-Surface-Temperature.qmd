...
A plot of the residuals from the linear model showed that they were evenly distributed, although were more positive (~4.0 min) than negative (~-3.0 max). The residuals for the anomaly model were also fairly evenly distributed in terms of values, however they did appear to exhibit some periodicity.