...
p
ggsave(filename = paste0(Dir, '/TC_map_', RptYr, '.pdf'), plot = p, width=8, height=4, units='in')
...
# Storm counts
pdf(paste(Dir, '/TC_counts_', RptYr, '.pdf', sep = ""), width = 8, height = 7)
par(oma=c(6,2.5,0,3), 
    mar=c(3,2,3,3), xpd=NA)
par(mfrow = c(4,1))
# EP
...
axis((4), at = seq(0, 700, 100), labels = c(0,'','','','','','',70), tck = -0.1, las = 1, cex.axis=1.5)
# CP
...
axis((4), at = seq(0, 700, 100), labels = c(0,'','','','','','',700), tck = -0.1, las = 1, cex.axis=1.5)
# WP
...
mtext('Accumulated Cyclone Energy \n(ACE) Index (10^4 kts^2)', side=4, line=2, outer = T, cex=1.1, font=2)
par(mar = c(0, 0, 0, 0))
# Legend
legend('bottomleft', 
       inset = c(0,-1.5), 
