...
#  borders('world2', fill='#A5A5A5', colour='gray40', linewidth=0.2) + #add land to the map
...
#  labs(title = paste(RptYr, 'averaged (shaded) and anomaly (contours)'))  #add figure title
#
# # # Add anomaly
# p <- p + 
...
#   scale_linetype_manual(values = c('dashed','solid','solid'), name='Difference from 1980-2009 average in 1°C') +  #adding legend to bottom of plot. Keep name the same for legends you want to combine (here it's linetype and linewidth)
