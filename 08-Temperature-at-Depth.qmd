...
pdf(paste(Dir, '/TempAtDepth_ts_', RptYr, '.pdf', sep = ""))
...
plot(dmy_hm(given_yr_ann$Date_Time), given_yr_ann$Value, type = "l", lwd = 2,
     ...
     col = pal[4],
     xlab = " ", ylab = " ")
axis(1, at = x_grid, label = c(seq(1980, 2020, 5), 2024, " "), col = "transparent", col.ticks = "transparent") 
...
pdf(paste(Dir, '/TempAtDepth_anom_ts_', RptYr, '.pdf', sep = ""))
...
# Create map
p <- ggplot() +
 geom_tile(data = maps_RptYr, mapping = aes(x = x, y = y, fill = layer)) + #data as raster
