...
# pdf(paste(Dir, '/TempAtDepth_ts_', RptYr, '.pdf', sep = ""), width=9, height=6)
...
#      bty = "n", # remove box
#      col = pal[1],
#      xlab = "Year", ylab = "200-300 m Temperature (°C)",
#      # put a grid behind the plot
#      panel.first = c(abline(v = x_grid, col = "#F1F3F3"),
#                      abline(h = c(seq(10.8, 11.7, 0.1)), col = "#F1F3F3")),
...
#      col = pal[4],
#      xlab = " ", ylab = " ")
# axis(1, at = x_grid, label = c(seq(1980, 2020, 5), 2025, " "), col = "transparent", col.ticks = "transparent") 
# axis(2, at = c(seq(10.8, 11.7, 0.1)), las = 1, col = "transparent", col.ticks = "transparent")
# grid.roundrect(x=0.51, y=0.075, width=0.6, height=0.12, 
#                r=unit(0.3, "snpc"), gp=gpar(fill="gray90", col='gray90'), just='centre')
# legend('bottom', 
#        legend=c(paste0('Monthly average, 1980-',RptYr-1), paste0('Annual average, 1980-',RptYr-1), 'Long-term Trend', paste0('Monthly average, ',RptYr), paste0('Annual average, ',RptYr)), 
...
#   summarise(Anom = mean(Anom, na.rm = TRUE))
# 
# # pdf(paste(Dir, '/TempAtDepth_anom_ts_', RptYr, '.pdf', sep = ""), width=8, height=6). # No annomaly for this indicator
# par(mar=c(8.6, 5.1, 2.1, 2.1))
...
#      bty = "n", # remove box
#      col = pal[1],
#      xlab = "Year", ylab = "200-300 m Temperature Anomaly (°C)",
#      # put a grid behind the plot
#      panel.first = c(abline(v = x_grid, col = "#F1F3F3"),
...
\
**Sourced from:** NOAA (2025d) and APDRC (2025).  Graphics produced in part using Stawitz and Li (2025).
...
p_map <- p_map +
  ...
  scale_linetype_manual(values = c('dashed','solid','solid'), name='Difference from 1980-2009 average in 1°C intervals') +  #adding legend to bottom of plot. Keep name the same for legends you want to combine (here it's linetype and linewidth)
  scale_linewidth_manual(values=c(0.25,0.25,1), name='Difference from 1980-2009 average in 1°C intervals') +
...
# pdf(paste(Dir, '/TempAtDepth_map_', RptYr, '.pdf', sep = ""), width=9, height=6)
# print(p)
# dev.off()
