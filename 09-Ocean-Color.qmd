...
Chl_2325 <- read_delim(file = paste(Dir, '/chl_ts_2325.dat', sep = ""), skip = 8, col_names = FALSE)

# Concatonate
Chl_full <- rbind(Chl_9802, Chl_0307, Chl_0812, Chl_1317, Chl_1822, Chl_2325)
```
...
# x-axis limits
ts_x_lim <- c(min(dmy_hm(indicator_data$Date_Time)), max(dmy_hm(indicator_data$Date_Time)))
# y-axis limits
