...
Chl_2324 <- read_delim(file = paste(Dir, '/chl_ts_2324.dat', sep = ""), skip = 8, col_names = FALSE)
...
pdf(paste(Dir, '/Chl_ts_', RptYr, '.pdf', sep = ""))
plot(dmy_hm(indicator_data$Date_Time), indicator_data$Value, type = "l", lwd = 2, 
     ...
     bty = "n", # remove box
     col = pal[1],
     xlab = "Year", ylab = "Chlorophyll-a Concentration (mg m-3)",
...
pdf(paste(Dir, '/Chl_anom_ts_', RptYr, '.pdf', sep = ""))  
plot(dmy_hm(indicator_data$Date_Time), indicator_data$Anom, type = "l", lwd = 2, 
     ...
     bty = "n", # remove box
     col = pal[1],
     xlab = "Year", ylab = "Chlorophyll-a Concentration Anomaly (mg m3)",
     # put a grid behind the plot
     panel.first = c(abline(v = x_grid, col = "#F1F3F3"),
...
plot(dmy_hm(given_yr_ann$Date_Time), given_yr_ann$Anom, type = "l", lwd = 2,
     ...
     xlab = " ", ylab = " ")
axis(1, at = x_grid, label = c(1998, seq(2000, 2020, 5), 2024, " "), col = "transparent", col.ticks = "transparent") 
axis(2, at = c(seq(-0.035, 0.005, 0.01), 0, seq(0.005, 0.035, 0.01)), las = 1, col = "transparent", col.ticks = "transparent")
dev.off()
