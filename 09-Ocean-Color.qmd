...
p <- p +
  ...
  scale_linetype_manual(values = c('dashed','solid','solid'), name='Difference from 1980-2009 average +-0.02 mg chl m-3') +  #adding legend to bottom of plot. Keep name the same for legends you want to combine (here it's linetype and linewidth)
  scale_linewidth_manual(values=c(0.25,0.25,1), name='Difference from 1980-2009 average +-0.02 mg chl m-3') +
