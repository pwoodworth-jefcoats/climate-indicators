...
ggsave(plot = i, filename = '~/Desktop/SAFE_all_test_ridges.png', width = 8, height = 16, dpi=300, units='in')
ggsave(plot = j, filename = '~/Desktop/SAFE_BET_test_ridges.png', width = 8, height = 16, dpi=300, units='in')
ggsave(plot = k, filename = '~/Desktop/SAFE_SWO_test_ridges.png', width = 8, height = 16, dpi=300, units='in')
```
