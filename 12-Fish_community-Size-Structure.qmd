...
i <- ridgefunc(dealer, col='#63a298', L50=-10, L50col=NA, xmax=90, xmin=-5, cutoff=0.02, alpha=0.5)
j <- ridgefunc(dealerBE, '#5b84a1', BET_L50_kg, L50col='gray30', xmax=105, bwidth=2, alpha=0.5)
k <- ridgefunc(dealerSW, '#ffba37', c(SW_L50_kg_f, SW_L50_kg_m), 'gray30', xmax=310, xmin=-10, overlap=2, bwidth=10) # try binwidth=10 as well
