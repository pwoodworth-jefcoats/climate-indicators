...
\
Status: No above-average peaks in two-year-old bigeye CPUE were observed in `r RptYr-2`-`r RptYr`, suggesting that there will not be a peak in the CPUE of four- and five-year-old bigeye in `r RptYr+1` or `r RptYr+2`.\
\
