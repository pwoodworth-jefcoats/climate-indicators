...
# Save the annual dealer data file for use in the dashboard
write.csv(dealerYear, paste0(Dir, '/SAFE_AnnualDealer_forDashboard_', RptYr, '.csv'), quote = F, row.names = F)
```
