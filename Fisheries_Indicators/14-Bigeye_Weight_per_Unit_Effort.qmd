...
cap <- paste0('Quarterly deep-set bigeye tuna weight per unit effort for ', RptYr-3, '-', RptYr-1, ' (color) and the climatological average (2000-2009)')
```

```{r fig-wpue, fig.cap=paste0('Quarterly deep-set bigeye tuna weight per unit effort for ', RptYr-3, '-', RptYr-1, ' (color) and the climatological average (2000-2009)'), out.width='70%', fig.align='center'}
...
<!--
![Quarterly deep-set bigeye tuna weight per unit effort for 2001-2023 (color) and the climatological average (2000-2009).](paste0('TEST_DELETE_SAFE_SizeFreqHist_', RptYr, '.png')){height=80%, #fig-wpue}
-->
