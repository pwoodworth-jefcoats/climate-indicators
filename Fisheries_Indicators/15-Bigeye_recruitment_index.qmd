...
# Make plot
png(paste0('TEST_DELETE_SAFE_RecIndexRaw_', RptYr, '.png'), height=6, width=11, res=300, unit='in')
# Make raw plot
par(mar=c(5,9,1,4.5))
...
setwd(Dir)
knitr::include_graphics(paste0('TEST_DELETE_SAFE_RecIndexRaw_', RptYr, '.png'))
