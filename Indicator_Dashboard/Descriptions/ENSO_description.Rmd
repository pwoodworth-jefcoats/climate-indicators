...
The Oceanic Niño Index (ONI) indicated a transition from El Niño to neutral conditions in `r RptYr`. In `r RptYr`, the ONI ranged from `r monthly_min_RptYr` to `r monthly_max_RptYr`.  This is within the range of values observed previously in the time series.
