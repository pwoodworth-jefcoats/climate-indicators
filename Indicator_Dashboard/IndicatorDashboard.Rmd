...
plot_spacer_1 <- 20 #in pixels
plot_spacer_2 <- 70 #in pixels
...
The dashboard data match the __2022__ pelagic SAFE report.  Dashboard data will be updated each summer following publication of the SAFE report.
...
output$ts_desc <- renderUI(
  ...
  #indicator-specific descriptions for time series plot
...
output$anom_desc <- renderUI(
  ...
  if (input$indicator == "CO2"){
    ...
    markdown("pH anomaly plot description")
  } else if (input$indicator == "ENSO"){
    markdown("ENSO anomaly plot description")
  } else if (input$indicator == "PDO"){
    markdown("PDO anomaly plot description")
  } else if (input$indicator == "SST"){
    markdown("SST anomaly plot description")
  } else if (input$indicator == "TatD"){
    markdown("TatD anomaly plot description")    
  } else if (input$indicator == "Chl"){
...
output$map <- renderPlotly({
  ...
  #indicators with spatial data (SST, TatD, Chl, and MD40)
  if (input$indicator %in% include_anom_map_list){
    ...
    p <- ggplot() + 
      ...
      geom_vline(xintercept = c(0, 60), color="black", linewidth = 0.1) +
