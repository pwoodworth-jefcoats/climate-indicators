...
runtime: shiny
resource_files:
  - "Data/Dashboard_Data_2025.csv"
  - "Data/Dashboard_Map_Data_2025.csv"
  - "Images/Indicator-Table-2025-Monthly-Variables.png"
  - "Images/CO2-Indicator-Table-2025-Monthly-Variables.png"
  - "Images/Chl-Indicator-Table-2025-Monthly-Variables.png"
  - "Images/ENSO-Indicator-Table-2025-Monthly-Variables.png"
  - "Images/MD50-Indicator-Table-2025-Monthly-Variables.png"
  - "Images/PDO-Indicator-Table-2025-Monthly-Variables.png"
  - "Images/SST-Indicator-Table-2025-Monthly-Variables.png"
  - "Images/TatD-Indicator-Table-2025-Monthly-Variables.png"
  - "Images/pH-Indicator-Table-2025-Monthly-Variables.png"
...
report_year <- 2025 #current report year
...
output$anom_map_desc <- renderUI(
  ...
  #indicator-specific descriptions for seasonal plot
  if (input$indicator == "SST") {
    markdown("This anomaly map shows the difference between SST in the report year (2025) and the long-term average (1985-2009).  Areas that were warmer in 2025 are red and areas that were cooler are blue.")
  } else if (input$indicator == "TatD") {
    markdown("This anomaly map shows the difference between temperature at depth in the report year (2025) and the long-term average (1980-2009).  Areas that were warmer in 2025 are red and areas that were cooler are blue.")    
  } else if (input$indicator == "Chl") {
    markdown("This anomaly map shows the difference between ocean color in the report year (2025) and the long-term average (1998-2009).  Areas with greater chl concentration in 2025 are red and areas with lower chl concentrations are blue.")    
  } else if (input$indicator == "MD50") {
    markdown("This anomaly map shows the difference between median phytoplankton size in the report year (2025) and the long-term average (1998-2009).  Areas with larger phytplankotn in 2025 are red and areas with smaller phytoplankton are blue.")    
  }  
