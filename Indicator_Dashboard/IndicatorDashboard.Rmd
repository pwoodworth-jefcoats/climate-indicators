...
output$season_desc <- renderUI(
  ...
  markdown('The __Seasonal Plots__ show the indicator values by month.  The cycle plot shows all the values for a given month in order by year. The points plot stacks them vertically.')
)
