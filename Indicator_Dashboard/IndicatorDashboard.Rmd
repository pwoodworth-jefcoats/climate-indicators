...
output$map <- renderPlotly({
  ...
  filename = here('Data', paste0(input$indicator, "_map_2022.csv"))
  raster_df <- read.csv(filename)
...
<span style="color: #A5A5A5;">This __Map__ shows the long-term average for this variable.</span>
...
output$anom_map <- renderPlotly({
  ...
  #read in plotting data
  filename = here('Data', paste0(input$indicator, "_anom_map_2022.csv"))
  raster_anom_df <- read.csv(filename)
...
<span style="color: #A5A5A5;">This __Anomaly Map__ shows the difference between the most recent year and the long-term average.  Positive values mean the most recent year is above average and negative values mean the most recent year is below average.</span>
...
```
>>>>>>> 37e5056484e78282ed691ef74d2a94784958c466
