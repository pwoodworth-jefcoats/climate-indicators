...
output$anom_map_desc <- renderUI(
  ...
  #indicator-specific descriptions for seasonal plot
  if (input$indicator == "SST") {
    markdown("This anomaly map shows the difference between SST in the report year (2022) and the long-term average (1985-2021).  Areas that were warmer in 2022 are red and areas that were cooler are blue.")
  } else if (input$indicator == "TatD") {
    markdown("This anomaly map shows the difference between temperature at depth in the report year (2022) and the long-term average (1980-2021).  Areas that were warmer in 2022 are red and areas that were cooler are blue.")    
  } else if (input$indicator == "Chl") {
    markdown("This anomaly map shows the difference between ocean color in the report year (2022) and the long-term average (1998-2021).  Areas with greater chl concentration in 2022 are red and areas with lower chl concentrations are blue.")    
  } else if (input$indicator == "MD50") {
    markdown("This anomaly map shows the difference between median phytoplankton size in the report year (2022) and the long-term average (1998-2021).  Areas with larger phytplankotn in 2022 are red and areas with smaller phytoplankton are blue.")    
  }  
