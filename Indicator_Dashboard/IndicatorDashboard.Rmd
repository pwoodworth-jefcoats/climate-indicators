...
<span style="color: #A5A5A5;">This is some text about the __Time Series Plot__</span>
...
output$anom_desc <- renderUI(
  ...
  markdown("<span style='color: #A5A5A5;'>This is some text about the __Anomaly Time Series Plot__</span>")
)
...
<span style="color: #A5A5A5;">This is some text about the __Seasonal Plots__</span>
...
<span style="color: #A5A5A5;">This is some text about the __Maps__</span>
