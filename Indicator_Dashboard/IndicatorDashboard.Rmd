...
runtime: shiny
resource_files:
  - "Data/Dashboard_Data_2023.csv"
  - "Data/Dashboard_Map_Data_2023.csv"
  - "Data/rnatearth_coast.RData"
  - "Data/rnatearth_land.RData"
  - "Images/Indicator-Table-2023-Monthly-Variables.png"
  - "Images/CO2-Indicator-Table-2023-Monthly-Variables.png"
  - "Images/Chl-Indicator-Table-2023-Monthly-Variables.png"
  - "Images/ENSO-Indicator-Table-2023-Monthly-Variables.png"
  - "Images/MD50-Indicator-Table-2023-Monthly-Variables.png"
  - "Images/PDO-Indicator-Table-2023-Monthly-Variables.png"
  - "Images/SST-Indicator-Table-2023-Monthly-Variables.png"
  - "Images/TatD-Indicator-Table-2023-Monthly-Variables.png"
  - "Images/pH-Indicator-Table-2023-Monthly-Variables.png"
...
report_year <- 2023 #current report year
...
output$season_desc <- renderUI(
  ...
  if (input$indicator == "CO2") {
    ...
    markdown("The seasonal cycle plot show PDO values over time by month.  The horizontal black lines are the time series average for each month.  This figure shows that there is no long-term trend in PDO values.")
  } else if (input$indicator == "SST") {
...
output$map_desc <- renderUI( 
  ...
  if (input$indicator == "CO2") {
    ...
    markdown("This map shows the climatological average SST (1985-2021).  The data in the graphs above is averaged over the longline fishing grounds.")
  } else if (input$indicator == "TatD") {
    markdown("This map shows the climatological average temperature at depth (1980-2021).  The data in the graphs above is averaged over the longline fishing grounds.")    
  } else if (input$indicator == "Chl") {
    markdown("This map shows the climatological average ocean color (1998-2021).  The data in the graphs above is averaged over the longline fishing grounds.")    
  } else if (input$indicator == "MD50") {
    markdown("This map shows the climatological average median phytoplankton size (1998-2021).  The data in the graphs above is averaged over the longline fishing grounds.")    
  }  
)
...
output$anom_map_desc <- renderUI(
  ...
  #indicator-specific descriptions for seasonal plot
  if (input$indicator == "SST") {
    markdown("This anomaly map shows the difference between SST in the report year (2023) and the long-term average (1985-2021).  Areas that were warmer in 2023 are red and areas that were cooler are blue.")
  } else if (input$indicator == "TatD") {
    markdown("This anomaly map shows the difference between temperature at depth in the report year (2023) and the long-term average (1980-2021).  Areas that were warmer in 2023 are red and areas that were cooler are blue.")    
  } else if (input$indicator == "Chl") {
    markdown("This anomaly map shows the difference between ocean color in the report year (2023) and the long-term average (1998-2021).  Areas with greater chl concentration in 2023 are red and areas with lower chl concentrations are blue.")    
  } else if (input$indicator == "MD50") {
    markdown("This anomaly map shows the difference between median phytoplankton size in the report year (2023) and the long-term average (1998-2021).  Areas with larger phytplankotn in 2023 are red and areas with smaller phytoplankton are blue.")    
  }  
